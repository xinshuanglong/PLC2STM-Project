...
#define USART1_RX_LEN 256 // 定义最大接收字节数 256
#define USART1_TX_LEN 16

#define USART2_RX_LEN 4092 // 定义最大接收字节数          256
#define USART2_TX_LEN 16

#define USART3_RX_LEN 256 // 定义最大接收字节数 256
#define USART3_TX_LEN 16

#define UART4_RX_LEN 256 // 定义最大接收字节数 256
#define UART4_TX_LEN 16

#define USART6_RX_LEN 256 // 定义最大接收字节数 256
