...
typedef union
{
    u16 u16Val; // element specifier for accessing whole u16
    s16 s16Val; // element specifier for accessing whole i16
    struct
    {              // Byte-order is big endian
        u8 u8ValL; // element specifier for accessing high u8
        u8 u8ValH; // element specifier for accessing low u8
